...
/*
PublicTweetsParams contains all the parameters to send to the API endpoint
for the get user by name operation typically these are written to a http.Request
*/
type PublicTweetsParams struct {
	Sort string
	LastId int
...
func (o *PublicTweetsParams) WriteToRequest(r client.Request, reg strfmt.Registry) error {
	// path param name
	if err := r.SetPathParam("tweet", "public_tweets"); err != nil {
		return err
	}
